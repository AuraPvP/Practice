...
public final class Kit {
    ...
    public boolean isSelectionItem(ItemStack itemStack) {
        ...
        return meta.hasDisplayName() && meta.getDisplayName().equals(ChatColor.RED.toString() + ChatColor.BOLD + name);
    }
    ...
    public ItemStack createSelectionItem() {
        ...
        itemMeta.setDisplayName(ChatColor.RED.toString() + ChatColor.BOLD + name);
