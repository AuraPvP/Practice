...
public final class LobbyItems {
    ...
    public static final ItemStack CREATE_PARTY = new ItemStack(Material.NAME_TAG);
    ...
    static {
        ...
        ItemUtils.setDisplayName(CREATE_PARTY, BLUE.toString() + BOLD + "» " + PINK + BOLD + "Create Party" + BLUE.toString() + BOLD + " «");
        ...
        ItemUtils.setDisplayName(PLAYER_STATISTICS, BLUE.toString() + BOLD + "» " + ChatColor.YELLOW.toString() + BOLD + "Statistics" + BLUE.toString() + BOLD + " «");;
    }
