...
public final class Party {
    ...
    public void invite(Player target) {
        ...
        invites.add(invite);
        Bukkit.getScheduler().runTaskLater(PotPvPND.getInstance(), () -> invites.remove(invite), PartyHandler.INVITE_EXPIRATION_SECONDS * 20);
    }
    ...
    public void resetInventoriesDelayed() {
        ...
        Bukkit.getScheduler().runTaskLater(PotPvPND.getInstance(), this::resetInventoriesNow, InventoryUtils.RESET_DELAY_TICKS);
    }
