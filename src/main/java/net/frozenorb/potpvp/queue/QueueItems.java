...
public final class QueueItems {
    ...
    static {
        ItemUtils.setDisplayName(JOIN_SOLO_UNRANKED_QUEUE_ITEM, BLUE.toString() + BOLD + "» " + GREEN + BOLD + "Join " + AQUA + BOLD + "Unranked" + GREEN + BOLD + " Queue" + BLUE.toString() + BOLD + " «");
        ...
        ItemUtils.setDisplayName(JOIN_SOLO_RANKED_QUEUE_ITEM, BLUE.toString() + BOLD + "» " + GREEN + BOLD + "Join " + BLUE + BOLD + "Ranked" + GREEN + BOLD + " Queue" + BLUE.toString() + BOLD + " «");
